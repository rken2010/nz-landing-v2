...
export function ProyectCard (props: IAppProps) {
  return (
    <div className={styles.card__container}>
      ...
      <div>
        <h3 className={styles.card__title}>REUNION INICIAL</h3>
      </div>
      <div>
        <p className={styles.card__txt}>Recopilamos la información para el desarrollo del proyecto, como los objetivos del proyecto, el presupuesto disponible, las necesidades y preferencias del cliente.</p>
      </div>
